...
class OpeningsControllerTest < ActionController::TestCase
  ...
  test "should create opening" do
    assert_difference('Opening.count') do
      post :create, opening: { Completed: @opening.Completed, Lat: @opening.Lat, Long: @opening.Long, Requested: @opening.Requested, user_id: @opening.user_id }
    end
  ...
  test "should update opening" do
    patch :update, id: @opening, opening: { Completed: @opening.Completed, Lat: @opening.Lat, Long: @opening.Long, Requested: @opening.Requested, user_id: @opening.user_id }
    assert_redirected_to opening_path(assigns(:opening))
  end
